...
start_date = st.date_input('Start Date', pd.to_datetime('2021-01-02'), format='YYYY/MM/DD')
end_date = st.date_input('End Date', pd.to_datetime('2024-01-02'), format='YYYY/MM/DD')
